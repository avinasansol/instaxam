<?php 
	...
	$page = "task-tracker-update.php";
	if(!isset($_SESSION['LogdUsrDet']))
	{
		header("Location: index.php");
	}
	include("include/task-tracker-update.php");
...
<html lang="en">
  ...
  <head>
    ...
    <title>Instaxam.In - Update Task Tracker</title>
				...
				<div id="history-table">
                    ...
                    <h2 style="font-size:18px;">
                        ...
                        <select name="Month" style="font-size:14px;" onchange="this.form.submit()">
                            <?php if( (isset($_POST['Month'])) && ( ($_POST['Month']==date('Y-m-01')) || ($_POST['Month']==date('Y-m-01', strtotime('-1 MONTH'))) || ($_POST['Month']==date('Y-m-01', strtotime('-2 MONTH'))) || ($_POST['Month']==date('Y-m-01', strtotime('-3 MONTH'))) ) ){?>
                    ...
                    <form action="task-tracker.php" method="get">
                        <button type="submit">Open In View Mode</button>
                    </form><br />
					<div>
					<table>
                        <thead>
                        ...
                        <tbody>
                            <?php 
                                ...
                                if( (isset($_POST['Month'])) && ($_POST['Month']==date('Y-m-01', strtotime('-1 MONTH'))) ){
                                            ...
                                            if($row2 = mysqli_fetch_array($result2)){
                                                ...
                                                <td style="background:<?php 
                                                    if($diffFromPrevDay == 1){
                                                        $dispColor[$taskCount] = "none";
                                                        if( ($row2['td_value']=="Y") || ($timeColor == 1) || ($remarkColor == 1) ){
                                                            $dispColor[$taskCount] = "#81d41a";
                                                        } else if( ($row2['td_value']=="N") || ($timeColor == 3) || ($remarkColor == 3) ){
                                                            $dispColor[$taskCount] = "#f17b1a";
                                                        }else if( ($timeColor == 2) ){
                                                            $dispColor[$taskCount] = "#fff200";
                                                        }
                                                    }
                                                    echo $dispColor[$taskCount];
                                                    ?>;">
                                                    <span class='chng-val'>
                                                        <form method="post" action="<?php echo $page;?>">
                                                            <input name="Month" type="hidden" value="<?php echo ($dt->format("Y-m"))."-01"; ?>" />
                                                            <input name="Task-Rem" type="hidden" value="T" />
                                                            <input name="Task-Date" type="hidden" value="<?php echo ($dt->format("Y-m-d"));?>" />
                                                            <input name="Task-Id" type="hidden" value="<?php echo $row1['tm_id'];?>" />
                                                            <?php 
                                                                if($row1['tm_task_type']=="YN"){
                                                            ?>
                                                            <select name="Task-Val" onchange="this.form.submit()">
                                                                <option value="<?php echo $row2['td_value']; ?>"><?php if($row2['td_value']==""){echo "NA";}else{echo $row2['td_value'];} ?></option>
                                                                <?php if($row2['td_value']=="Y") { ?>
                                                                <option value="N">N</option>
                                                                <option value="">NA</option>
                                                                <?php } else if($row2['td_value']=="N") { ?>
                                                            ...
                                                            <?php 
                                                                } else if($row1['tm_task_type']=="T"){
                                                            ?>
                                                            <select name="Task-Val" onchange="this.form.submit()">
                                                                <option value="<?php echo $row2['td_value']; ?>"><?php echo $row2['td_value']; ?></option>
                                                                <option value="">NA</option>
                                                                <?php 
                                                                    $min = 0;
                                                                    $hr = 0;
                                                                    while($hr<25){
                                                                        ...
                                                                        if($timeD!=$row2['td_value']){ 
                                                                ?>
                                                                        <option value="<?php echo $timeD;?>"><?php echo $timeD;?></option>
                                                                <?php 
                                                                        }
                                                                        $min = $min +15;
                                                                        if($min == 60) {
                                                            ...
                                                            <select name="Task-Val" onchange="this.form.submit()">
                                                                ...
                                                                <?php 
                                                                    $i=0; 
                                                                    while($i<201){
                                                                        if($i!=(int)$row2['td_value']){ 
                                                                ?>
                                                                        <option value="<?php echo $i;?>"><?php echo $i;?></option>
                                                                <?php 
                                                                        } 
                                                                        if( (($i.".33")!=(int)$row2['td_value']) && ($i<10) ){ 
                                                                ?>
                                                                        <option value="<?php echo $i.".33";?>"><?php echo $i.".33";?></option>
                                                                <?php 
                                                                        } 
                                                                        if( (($i.".67")!=(int)$row2['td_value']) && ($i<10) ){ 
                                                                ?>
                                                                        <option value="<?php echo $i.".67";?>"><?php echo $i.".67";?></option>
                                                                <?php 
                                                                        } 
                                                                        if($i<10){
                                                                            $i++;
                                                            ...
                                                            ?>
                                                            <textarea name="Task-Val" required="" style="max-height:250px;min-height:50px;max-width:400px;min-width:330px;"><?php echo $row2['td_value']; ?></textarea>
                                                            <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                            <?php 
                                                                } else {
                                                            ?>
                                                            <input name="Task-Val" type="text" value="<?php echo $row2['td_value']; ?>" />
                                                            <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                            <?php 
                                                                }
                                                            ?>
                                                ...
                                                <td>
                                                    <span class='chng-val'>
                                                        <form method="post" action="<?php echo $page;?>">
                                                            ...
                                                            ?>
                                                            <textarea name="Task-Val" required="" style="max-height:250px;min-height:50px;max-width:400px;min-width:330px;"></textarea>
                                                            <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                            <?php 
                                                                } else {
                                                            ?>
                                                            <input name="Task-Val" type="text" value="" />
                                                            <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                            <?php 
                                                                }
                                                            ?>
                                                    ...
                                                    if($row3 = mysqli_fetch_array($result3)){
                                                        ...
                                                        ?>;"<?php if($taskRowspan[$taskCount]>0){echo " rowspan='".($taskRowspan[$taskCount]+1)."'";}?>>
                                                            <span class='chng-val'>
                                                                <form method="post" action="<?php echo $page;?>">
                                                                <input name="Month" type="hidden" value="<?php echo ($dt->format("Y-m"))."-01"; ?>" />
                                                                    <input name="Task-Rem" type="hidden" value="R" />
                                                                    <input name="Task-Date" type="hidden" value="<?php echo ($dt->format("Y-m-d"));?>" />
                                                                    <input name="Task-Id" type="hidden" value="<?php echo $row1['tm_id'];?>" />
                                                                    <?php 
                                                                        if($row1['tm_remark_type']=="YN"){
                                                                    ?>
                                                                    <select name="Task-Val" onchange="this.form.submit()">
                                                                        <option value="<?php echo $row3['td_value']; ?>"><?php if($row3['td_value']==""){echo "NA";}else{echo $row3['td_value'];} ?></option>
                                                                        <?php if($row3['td_value']=="Y") { ?>
                                                                            <option value="N">N</option>
                                                                            <option value="">NA</option>
                                                                        <?php } else if($row3['td_value']=="N") { ?>
                                                                            <option value="Y">Y</option>
                                                                            <option value="">NA</option>
                                                                        <?php } else { ?>
                                                                            <option value="Y">Y</option>
                                                                    ...
                                                                    <?php 
                                                                        } else if($row1['tm_remark_type']=="T"){
                                                                    ?>
                                                                    <select name="Task-Val" onchange="this.form.submit()">
                                                                        <option value="<?php echo $row3['td_value']; ?>"><?php echo $row3['td_value']; ?></option>
                                                                        <option value="">NA</option>
                                                                        <?php 
                                                                            $min = 0;
                                                                            $hr = 0;
                                                                    ...
                                                                    <select name="Task-Val" onchange="this.form.submit()">
                                                                        ...
                                                                        <?php 
                                                                            $i=0; 
                                                                            while($i<201){
                                                                                if($i!=(int)$row3['td_value']){ 
                                                                        ?>
                                                                                <option value="<?php echo $i;?>"><?php echo $i;?></option>
                                                                        <?php 
                                                                                } 
                                                                                if( (($i.".33")!=$row3['td_value']) && ($i<10) ){ 
                                                                        ?>
                                                                                <option value="<?php echo $i.".33";?>"><?php echo $i.".33";?></option>
                                                                        <?php 
                                                                                } 
                                                                                if( (($i.".67")!=$row3['td_value']) && ($i<10) ){ 
                                                                        ?>
                                                                                <option value="<?php echo $i.".67";?>"><?php echo $i.".67";?></option>
                                                                        <?php 
                                                                                } 
                                                                    ...
                                                                    <?php 
                                                                        } else if($row1['tm_remark_type']=="AN"){
                                                                    ?>
                                                                    <textarea name="Task-Val" required="" style="max-height:250px;min-height:50px;max-width:400px;min-width:330px;"><?php echo $row3['td_value']; ?></textarea>
                                                                    <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                                    <?php 
                                                                        } else {
                                                                    ?>
                                                                    <input name="Task-Val" type="text" value="<?php echo $row3['td_value']; ?>" />
                                                                    <input type="submit" value="" style="height:32px; width:30px; background: url(assets/images/edit-save.png) no-repeat;background-position: 0px -91px !important; cursor:pointer; border:none;" />
                                                                    <?php 
                                                                        }
                                                                    ?>
